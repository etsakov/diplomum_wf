        ...
        if line:
            ...
            if "instrument" in msg or "tick" in msg or displayHeartbeat:
                ...
                if msg['type'] == 'PRICE':
                    ...
                    cur_state['spread'] = float('%.5f' % (float(msg['asks'][0]['price']) - float(msg['bids'][0]['price'])))
                ...
                for data_row in states_collection:
                    worksheet1.cell(row = item + 1, column = 1).value = states_collection[len(states_collection) - 1]['date_time']
                    worksheet1.cell(row = item + 1, column = 2).value = states_collection[len(states_collection) - 1]['status']
                    worksheet1.cell(row = item + 1, column = 3).value = states_collection[len(states_collection) - 1]['ask_closeout']
                    worksheet1.cell(row = item + 1, column = 4).value = states_collection[len(states_collection) - 1]['bid_closeout']
                    worksheet1.cell(row = item + 1, column = 5).value = states_collection[len(states_collection) - 1]['ask']
                    worksheet1.cell(row = item + 1, column = 6).value = states_collection[len(states_collection) - 1]['bid']
                    worksheet1.cell(row = item + 1, column = 7).value = states_collection[len(states_collection) - 1]['spread']
